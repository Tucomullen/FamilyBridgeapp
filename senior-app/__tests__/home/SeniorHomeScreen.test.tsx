...
describe('SeniorHomeScreen', () => {
  ...
  it('renders title and 3 action buttons', () => {
    ...
    expect(buttons).toHaveLength(5); // 3 action buttons + 1 TTS button + 1 title button
  ...
  it('navigates to Call screen when Call button is pressed', async () => {
  ...
  it('navigates to SOS screen when SOS button is pressed', async () => {
    const { getByRole } = render(
      <SeniorHomeScreen navigation={mockNavigation} />
    );
  ...
  it('navigates to Photos screen when Photos button is pressed', async () => {
    const { getByRole } = render(
      <SeniorHomeScreen navigation={mockNavigation} />
    );
